...
describe("v0.7.12 docs coverage", () => {
  ...
  it("README declares v0.7.12", () => {
    expect(readme).toContain("0.7.12");
  });
  ...
  it("README links to v0.7.12 assets in both download tables", () => {
    expect(readme).toContain("releases/download/v0.7.12/");
    expect(readme).toContain("Gridline_0.7.12_aarch64.dmg");
    expect(readme).toContain("Gridline-0.7.12-1.x86_64.rpm");
  });
});