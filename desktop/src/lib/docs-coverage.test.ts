...
describe("v0.7.13 docs coverage", () => {
  ...
  it("README declares v0.7.13", () => {
    expect(readme).toContain("0.7.13");
  });
  ...
  it("README links to v0.7.13 assets in both download tables", () => {
    expect(readme).toContain("releases/download/v0.7.13/");
    expect(readme).toContain("Gridline_0.7.13_aarch64.dmg");
    expect(readme).toContain("Gridline-0.7.13-1.x86_64.rpm");
  });
});