...
export function Button({ variant = "primary", className = "", children, ...rest }: ButtonProps) {
  ...
  const styles = variant === "primary" ? "bg-accent text-white hover:bg-accent-hover border-accent/50" : "text-white/70 hover:text-white border-white/10 hover:border-white/20";
  return (
